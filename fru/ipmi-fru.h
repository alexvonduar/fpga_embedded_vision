...
extern char *fru_get_fru_id(struct fru_common_header *header);

extern struct fru_type_length* fru_get_board_tl(struct fru_common_header *header, int nr);
extern char* fru_alloc_get_tl(struct fru_common_header *header, int nr);
