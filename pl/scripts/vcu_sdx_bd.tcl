...
################################################################
# This is a generated script based on design: vcu_sdx
#
...
proc create_hier_cell_mpsoc_ss { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU__TSU__BUFG_PORT_PAIR {NA} \
  ...
  connect_bd_net -net In0_1 [get_bd_pins In0] [get_bd_pins interrupts1/In0]
  connect_bd_net -net In1_1 [get_bd_pins In1] [get_bd_pins interrupts1/In1]
  connect_bd_net -net In2_1 [get_bd_pins In2] [get_bd_pins interrupts1/In2]
  connect_bd_net -net In3_1 [get_bd_pins In3] [get_bd_pins interrupts1/In3]
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net aresetn_100M [get_bd_ports SI5319_RST] [get_bd_pins axi_interconnect_0/S08_ARESETN] [get_bd_pins hdmi_input/aresetn_100M] [get_bd_pins hdmi_output/aresetn_100M] [get_bd_pins mpsoc_ss/aresetn_100M] [get_bd_pins vid_phy_controller/vid_phy_axi4lite_aresetn] [get_bd_pins vid_phy_controller/vid_phy_sb_aresetn]
  connect_bd_net -net clk_100M [get_bd_pins axi_interconnect_0/S08_ACLK] [get_bd_pins hdmi_input/clk_100M] [get_bd_pins hdmi_output/clk_100M] [get_bd_pins mpsoc_ss/clk_100M] [get_bd_pins vcu_0/s_axi_lite_aclk] [get_bd_pins vid_phy_controller/drpclk] [get_bd_pins vid_phy_controller/vid_phy_axi4lite_aclk] [get_bd_pins vid_phy_controller/vid_phy_sb_aclk]
  ...
  connect_bd_net -net hdmi_input_interrupt1 [get_bd_pins hdmi_input/interrupt1] [get_bd_pins mpsoc_ss/In3]
  connect_bd_net -net hdmi_input_interrupt_0 [get_bd_pins hdmi_input/interrupt_0] [get_bd_pins mpsoc_ss/In2]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins axi_interconnect_0/S02_ARESETN] [get_bd_pins axi_interconnect_0/S03_ARESETN] [get_bd_pins axi_interconnect_0/S04_ARESETN] [get_bd_pins axi_interconnect_0/S05_ARESETN] [get_bd_pins axi_interconnect_0/S06_ARESETN] [get_bd_pins axi_interconnect_0/S07_ARESETN] [get_bd_pins axi_interconnect_1/ARESETN] [get_bd_pins axi_interconnect_1/M00_ARESETN] [get_bd_pins axi_interconnect_1/S00_ARESETN] [get_bd_pins axi_interconnect_1/S01_ARESETN] [get_bd_pins axi_interconnect_2/ARESETN] [get_bd_pins axi_interconnect_2/M00_ARESETN] [get_bd_pins axi_interconnect_2/S00_ARESETN] [get_bd_pins axi_interconnect_2/S01_ARESETN] [get_bd_pins axi_interconnect_3/ARESETN] [get_bd_pins axi_interconnect_3/M00_ARESETN] [get_bd_pins axi_interconnect_3/S00_ARESETN] [get_bd_pins axi_interconnect_4/ARESETN] [get_bd_pins axi_interconnect_4/M00_ARESETN] [get_bd_pins axi_interconnect_4/S00_ARESETN] [get_bd_pins axi_interconnect_4/S01_ARESETN] [get_bd_pins axi_interconnect_4/S02_ARESETN] [get_bd_pins axi_interconnect_4/S03_ARESETN] [get_bd_pins axi_interconnect_4/S04_ARESETN] [get_bd_pins axi_interconnect_4/S05_ARESETN] [get_bd_pins hdmi_input/aresetn_300M] [get_bd_pins hdmi_output/aresetn_300M] [get_bd_pins mpsoc_ss/reset_333] [get_bd_pins proc_sys_reset_1/peripheral_aresetn]
  connect_bd_net -net rx_video_clk [get_bd_pins hdmi_input/video_clk] [get_bd_pins vid_phy_controller/rx_video_clk]
  connect_bd_net -net rxoutclk [get_bd_pins hdmi_input/link_clk] [get_bd_pins vid_phy_controller/rxoutclk] [get_bd_pins vid_phy_controller/vid_phy_rx_axi4s_aclk]
  connect_bd_net -net txoutclk [get_bd_pins hdmi_output/link_clk] [get_bd_pins vid_phy_controller/txoutclk] [get_bd_pins vid_phy_controller/vid_phy_tx_axi4s_aclk]
  ...
  set_property PFM_NAME {xilinx.com:xd:zcu106_vcu_trd:1.0} [get_files [current_bd_design].bd]
  set_property PFM.AXI_PORT {S02_AXI {memport "S_AXI_HP" sptag "HP"}} [get_bd_cells /axi_interconnect_1]
  set_property PFM.AXI_PORT {S02_AXI  {memport "S_AXI_HP" sptag "HP"}  } [get_bd_cells /axi_interconnect_2]
  set_property PFM.CLOCK {clk_out2 {id "1" is_default "true"  proc_sys_reset "proc_sys_reset_1"}  } [get_bd_cells /clk_wiz_1]
  set_property PFM.AXI_PORT {M24_AXI {memport "M_AXI_GP" sptag "GP"} M25_AXI {memport "M_AXI_GP" sptag "GP"}} [get_bd_cells /mpsoc_ss/axi_interconnect]
  set_property PFM.IRQ {In4 {} In5 {} In6 {} In7 {}} [get_bd_cells /mpsoc_ss/interrupts1]
