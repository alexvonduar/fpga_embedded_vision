...
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets {vcu_sdx_i/gt_refclk_buf/ibufds_gt/U0/IBUF_OUT[0]}]
...
#set_clock_groups -name mux_clk -logically_exclusive -group [get_clocks [list  [get_clocks -of_objects [get_pins vcu_sdx_i/clk_wiz_1/inst/mmcme4_adv_inst/CLKOUT1]]]] -group [get_clocks clk_pl_2]
