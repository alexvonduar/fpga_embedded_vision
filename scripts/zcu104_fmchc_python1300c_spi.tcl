...
set board "ZCU104"
set clean "no"
set project "fmchc_python1300c_spi"
set tag "init"
...
if {[file exists $projects_folder/${project}.runs/impl_1/${project}_wrapper.sysdef] && [file exists ${projects_folder}/${project}.xpr] && [string match -nocase "no" $bd]} {
