...
proc add_ps_preset {part_name} {

   # add selection for customization depending on board choice (or none)
   create_bd_cell -type ip -vlnv xilinx.com:ip:zynq_ultra_ps_e ${part_name}
   apply_bd_automation -rule xilinx.com:bd_rule:zynq_ultra_ps_e -config {apply_board_preset "1" }  [get_bd_cells ${part_name}]

   set zynq_ultra_ps_e_0 [get_bd_cells ${part_name}]
...
set_property -dict [ list \
   ...
   CONFIG.PSU__GPIO_EMIO_WIDTH {93} \
   CONFIG.PSU__GPIO_EMIO__PERIPHERAL__ENABLE {1} \
   CONFIG.PSU__GPIO_EMIO__PERIPHERAL__IO {93} \
...
proc add_ps {part_name} {
   avnet_add_ps_preset $part_name
