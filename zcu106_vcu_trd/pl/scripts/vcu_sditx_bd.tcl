...
proc create_hier_cell_sdi_tx_output { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.LAYER2_VIDEO_FORMAT {26} \
   CONFIG.LAYER3_ALPHA {true} \
   CONFIG.LAYER3_VIDEO_FORMAT {26} \
   CONFIG.LAYER4_VIDEO_FORMAT {23} \
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net S01_AXI_3 [get_bd_intf_pins axi_interconnect_0/S01_AXI] [get_bd_intf_pins sdi_tx_output/m_axi_mm_video1]
  connect_bd_intf_net -intf_net S02_AXI_1 [get_bd_intf_pins axi_interconnect_0/S02_AXI] [get_bd_intf_pins sdi_tx_output/m_axi_mm_video2]
  connect_bd_intf_net -intf_net S03_AXI_1 [get_bd_intf_pins axi_interconnect_0/S03_AXI] [get_bd_intf_pins sdi_tx_output/m_axi_mm_video3]
  connect_bd_intf_net -intf_net S04_AXI_1 [get_bd_intf_pins axi_interconnect_0/S04_AXI] [get_bd_intf_pins sdi_tx_output/m_axi_mm_video4]
  connect_bd_intf_net -intf_net S05_AXI_1 [get_bd_intf_pins axi_interconnect_0/S05_AXI] [get_bd_intf_pins sdi_tx_output/m_axi_mm_video5]
  ...
  create_bd_addr_seg -range 0x000800000000 -offset 0x000800000000 [get_bd_addr_spaces vcu_0/EncData0] [get_bd_addr_segs zynq_us_ss/zynq_us/SAXIGP2/HP0_DDR_HIGH] SEG_zynq_us_HP0_DDR_HIGH
  create_bd_addr_seg -range 0x000800000000 -offset 0x000800000000 [get_bd_addr_spaces vcu_0/EncData1] [get_bd_addr_segs zynq_us_ss/zynq_us/SAXIGP2/HP0_DDR_HIGH] SEG_zynq_us_HP0_DDR_HIGH
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces vcu_0/EncData0] [get_bd_addr_segs zynq_us_ss/zynq_us/SAXIGP2/HP0_DDR_LOW] SEG_zynq_us_HP0_DDR_LOW
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces vcu_0/EncData1] [get_bd_addr_segs zynq_us_ss/zynq_us/SAXIGP2/HP0_DDR_LOW] SEG_zynq_us_HP0_DDR_LOW
  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces vcu_0/EncData0] [get_bd_addr_segs zynq_us_ss/zynq_us/SAXIGP2/HP0_LPS_OCM] SEG_zynq_us_HP0_LPS_OCM
  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces vcu_0/EncData1] [get_bd_addr_segs zynq_us_ss/zynq_us/SAXIGP2/HP0_LPS_OCM] SEG_zynq_us_HP0_LPS_OCM
  create_bd_addr_seg -range 0x20000000 -offset 0xC0000000 [get_bd_addr_spaces vcu_0/EncData0] [get_bd_addr_segs zynq_us_ss/zynq_us/SAXIGP2/HP0_QSPI] SEG_zynq_us_HP0_QSPI
  create_bd_addr_seg -range 0x20000000 -offset 0xC0000000 [get_bd_addr_spaces vcu_0/EncData1] [get_bd_addr_segs zynq_us_ss/zynq_us/SAXIGP2/HP0_QSPI] SEG_zynq_us_HP0_QSPI
  create_bd_addr_seg -range 0x000800000000 -offset 0x000800000000 [get_bd_addr_spaces vcu_0/DecData0] [get_bd_addr_segs zynq_us_ss/zynq_us/SAXIGP3/HP1_DDR_HIGH] SEG_zynq_us_HP1_DDR_HIGH
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces vcu_0/DecData0] [get_bd_addr_segs zynq_us_ss/zynq_us/SAXIGP3/HP1_DDR_LOW] SEG_zynq_us_HP1_DDR_LOW
  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces vcu_0/DecData0] [get_bd_addr_segs zynq_us_ss/zynq_us/SAXIGP3/HP1_LPS_OCM] SEG_zynq_us_HP1_LPS_OCM
  create_bd_addr_seg -range 0x20000000 -offset 0xC0000000 [get_bd_addr_spaces vcu_0/DecData0] [get_bd_addr_segs zynq_us_ss/zynq_us/SAXIGP3/HP1_QSPI] SEG_zynq_us_HP1_QSPI
