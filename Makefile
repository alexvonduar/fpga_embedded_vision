...
fmchc_python1300c_myir7020:
	make -C ${TOP}/myir/ TOP=${TOP} BOARD=MYIR7020 INPUT_PORT=FMC_PYTHON3000 OUTPUT_PORT=FMC_HDMI all

fmchc_python1300c_zynqdev:
	make -C ${TOP}/myir/ TOP=${TOP} BOARD=ZYNQ_DEV INPUT_PORT=FMC_PYTHON3000 OUTPUT_PORT=FMC_HDMI all
