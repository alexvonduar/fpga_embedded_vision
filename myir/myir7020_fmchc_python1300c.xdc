...
set_property PACKAGE_PIN U12   [get_ports {FMC_HDMII_data[0]}]
set_property PACKAGE_PIN T12   [get_ports {FMC_HDMII_data[1]}] 
set_property PACKAGE_PIN Y19   [get_ports {FMC_HDMII_data[2]}]
set_property PACKAGE_PIN Y14   [get_ports {FMC_HDMII_data[3]}]
set_property PACKAGE_PIN W15   [get_ports {FMC_HDMII_data[4]}]
set_property PACKAGE_PIN Y18   [get_ports {FMC_HDMII_data[5]}]
set_property PACKAGE_PIN W14   [get_ports {FMC_HDMII_data[6]}]
set_property PACKAGE_PIN V15   [get_ports {FMC_HDMII_data[7]}]
set_property PACKAGE_PIN R14   [get_ports {FMC_HDMII_data[8]}]
set_property PACKAGE_PIN P14   [get_ports {FMC_HDMII_data[9]}]
set_property PACKAGE_PIN W13   [get_ports {FMC_HDMII_data[10]}]
set_property PACKAGE_PIN V12   [get_ports {FMC_HDMII_data[11]}]
set_property PACKAGE_PIN Y17   [get_ports {FMC_HDMII_data[12]}]
set_property PACKAGE_PIN Y16   [get_ports {FMC_HDMII_data[13]}]
set_property PACKAGE_PIN T10   [get_ports {FMC_HDMII_data[14]}]
set_property PACKAGE_PIN T11   [get_ports {FMC_HDMII_data[15]}]
set_property PACKAGE_PIN W20   [get_ports {FMC_HDMII_spdif}]
...
set_property PACKAGE_PIN H17   [get_ports FMC_HDMIO_clk]
set_property PACKAGE_PIN U20   [get_ports {FMC_HDMIO_data[0]}]
set_property PACKAGE_PIN T20   [get_ports {FMC_HDMIO_data[1]}]
set_property PACKAGE_PIN P20   [get_ports {FMC_HDMIO_data[2]}]
set_property PACKAGE_PIN G20   [get_ports {FMC_HDMIO_data[3]}]
set_property PACKAGE_PIN N20   [get_ports {FMC_HDMIO_data[4]}]
set_property PACKAGE_PIN L20   [get_ports {FMC_HDMIO_data[5]}]
set_property PACKAGE_PIN U15   [get_ports {FMC_HDMIO_data[6]}]
set_property PACKAGE_PIN G19   [get_ports {FMC_HDMIO_data[7]}]
set_property PACKAGE_PIN L19   [get_ports {FMC_HDMIO_data[8]}]
set_property PACKAGE_PIN L15   [get_ports {FMC_HDMIO_data[9]}]
set_property PACKAGE_PIN U14   [get_ports {FMC_HDMIO_data[10]}]
set_property PACKAGE_PIN M20   [get_ports {FMC_HDMIO_data[11]}]
set_property PACKAGE_PIN L14   [get_ports {FMC_HDMIO_data[12]}]
set_property PACKAGE_PIN J14   [get_ports {FMC_HDMIO_data[13]}]
set_property PACKAGE_PIN M19   [get_ports {FMC_HDMIO_data[14]}]
set_property PACKAGE_PIN K14   [get_ports {FMC_HDMIO_data[15]}]
set_property PACKAGE_PIN V20   [get_ports FMC_HDMIO_spdif]
...
set_property PACKAGE_PIN K18   [get_ports FMC_CAM_reset_n]
set_property PACKAGE_PIN N16   [get_ports {FMC_CAM_trigger[2]}]
set_property PACKAGE_PIN J20   [get_ports {FMC_CAM_trigger[1]}]
set_property PACKAGE_PIN H20   [get_ports {FMC_CAM_trigger[0]}]
set_property PACKAGE_PIN K16   [get_ports {FMC_CAM_monitor[0]}]
set_property PACKAGE_PIN J16   [get_ports {FMC_CAM_monitor[1]}]
set_property PACKAGE_PIN H15   [get_ports FMC_SPI_spi_sclk]
set_property PACKAGE_PIN G15   [get_ports FMC_SPI_spi_ssel_n]
set_property PACKAGE_PIN M14   [get_ports FMC_SPI_spi_mosi]
set_property PACKAGE_PIN M15   [get_ports FMC_SPI_spi_miso]
set_property PACKAGE_PIN J18   [get_ports FMC_CAM_clk_out_p]; #CAM_CLK_P
set_property PACKAGE_PIN H18   [get_ports FMC_CAM_clk_out_n]; #CAM_CLK_N
set_property PACKAGE_PIN M17   [get_ports FMC_CAM_sync_p]; #CAM_SYNC_P
set_property PACKAGE_PIN M18   [get_ports FMC_CAM_sync_n]; #CAM_SYNC_N
#set_property PACKAGE_PIN F19   [get_ports {FMC_CAM_data_p[]}]; #CAM_DATA7_P
#set_property PACKAGE_PIN F20   [get_ports {FMC_CAM_data_n[]}]; #CAM_DATA7_N
#set_property PACKAGE_PIN C20   [get_ports {FMC_CAM_data_p[]}]; #CAM_DATA6_P
#set_property PACKAGE_PIN B20   [get_ports {FMC_CAM_data_n[]}]; #CAM_DATA6_N
set_property PACKAGE_PIN D19   [get_ports {FMC_CAM_data_p[3]}]; #CAM_DATA5_P
set_property PACKAGE_PIN D20   [get_ports {FMC_CAM_data_n[3]}]; #CAM_DATA5_N
set_property PACKAGE_PIN G17   [get_ports {FMC_CAM_data_p[2]}]; #CAM_DATA4_P
set_property PACKAGE_PIN G18   [get_ports {FMC_CAM_data_n[2]}]; #CAM_DATA4_N
set_property PACKAGE_PIN B19   [get_ports {FMC_CAM_data_p[1]}]; #CAM_DATA3_P
set_property PACKAGE_PIN A20   [get_ports {FMC_CAM_data_n[1]}]; #CAM_DATA3_N
set_property PACKAGE_PIN E18   [get_ports {FMC_CAM_data_p[0]}]; #CAM_DATA2_P
set_property PACKAGE_PIN E19   [get_ports {FMC_CAM_data_n[0]}]; #CAM_DATA2_N
#set_property PACKAGE_PIN E17   [get_ports {FMC_CAM_data_p[]}]; #CAM_DATA1_P
#set_property PACKAGE_PIN D18   [get_ports {FMC_CAM_data_n[]}]; #CAM_DATA1_N
#set_property PACKAGE_PIN K19   [get_ports {FMC_CAM_data_p[]}]; #CAM_DATA0_P
#set_property PACKAGE_PIN J19   [get_ports {FMC_CAM_data_n[]}]; #CAM_DATA0_N
...
set_property PACKAGE_PIN K17   [get_ports FMC_VCLK]
