...
if {[string equal ${BOARD} "ultra96v2"]} {
    create_project -part xczu3eg-sbva484-1-e -in_memory ${PROJECT_NAME} ${outputDir}
    set_property board_part em.avnet.com:ultra96v2:part0:1.0 [current_project]	
} elseif {[string equal ${BOARD} "kv260"]} {
    create_project -part xck26-sfvc784-2LV-c -in_memory ${PROJECT_NAME} ${outputDir}
...
generate_target all -force [get_files $outputDir/design_1/design_1.bd]
compile_c [get_ips]
make_wrapper -files [get_files $outputDir/design_1/design_1.bd] -top -import -force
synth_design -name ${PROJECT_NAME} -top design_1_wrapper -include_dirs ${INC_DIR0}
read_xdc ${XDC_SRC}
opt_design
