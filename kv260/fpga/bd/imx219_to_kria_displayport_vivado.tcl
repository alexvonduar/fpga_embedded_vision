...
proc create_root_design { parentCell } {
   ...
   set ila_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:system_ila ila_0 ]
   set_property -dict [ list \
   ...
   set ila_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:system_ila ila_1 ]
   set_property -dict [ list \
   ...
   set ila_2 [ create_bd_cell -type ip -vlnv xilinx.com:ip:system_ila ila_2 ]
   set_property -dict [ list \
      CONFIG.C_MON_TYPE {INTERFACE} \
      CONFIG.C_NUM_OF_PROBES {9} \
      CONFIG.C_SLOT_0_INTF_TYPE {xilinx.com:interface:axis_rtl:1.0} \
   ...
   set ila_3 [ create_bd_cell -type ip -vlnv xilinx.com:ip:system_ila ila_3 ]
   set_property -dict [ list \
      CONFIG.C_MON_TYPE {INTERFACE} \
      CONFIG.C_NUM_OF_PROBES {9} \
      CONFIG.C_SLOT_0_INTF_TYPE {xilinx.com:interface:axis_rtl:1.0} \
   ...
   set ila_4 [ create_bd_cell -type ip -vlnv xilinx.com:ip:system_ila ila_4 ]
   set_property -dict [ list \
      CONFIG.C_MON_TYPE {INTERFACE} \
      CONFIG.C_NUM_OF_PROBES {9} \
      CONFIG.C_SLOT_0_INTF_TYPE {xilinx.com:interface:axis_rtl:1.0} \
