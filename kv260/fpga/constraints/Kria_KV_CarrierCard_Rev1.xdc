...
set_property PACKAGE_PIN J11      [get_ports "ap1302_rst_b"] ;# Bank  45 VCCO - som240_1_d18 - IO_L1P_AD15P_45
...
set_property IOSTANDARD  LVCMOS33 [get_ports "ap1302_standby"]; # Net name HDA03
...
set_property IOSTANDARD  LVCMOS33 [get_ports "ap1302_rst_b"]; # Net name HDA02
...
set_property SLEW SLOW [get_ports "ap1302_rst_b"]; # Net name HDA02
set_property SLEW SLOW [get_ports "ap1302_standby"]; # Net name HDA03
...
set_property DRIVE 4   [get_ports "ap1302_rst_b"]; # Net name HDA02
set_property DRIVE 4   [get_ports "ap1302_standby"]; # Net name HDA03
